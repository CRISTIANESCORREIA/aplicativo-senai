...
import com.example.appsenai.databinding.ActivityCadastroPessoaBinding;

public class CadastroPessoaActivity extends AppCompatActivity{

    ActivityCadastroPessoaBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityCadastroPessoaBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        binding.listviewAlunos.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(CadastroPessoaActivity.this, "item "+position+" Selecionado para exluir", Toast.LENGTH_SHORT).show();
                ...
                builder.setMessage("Deseja excluir a pessoa?").setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(CadastroPessoaActivity.this, "A pessoa sera exluida! ", Toast.LENGTH_SHORT).show();
        ...
        binding.listviewAlunos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(CadastroPessoaActivity.this, "item selecionado para editar", Toast.LENGTH_SHORT).show();
                //fazer ação para abrir nova tela com os dados do aluno selecionado.
            }
        });

        binding.btnCadastroAluno.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CadastroPessoaActivity.this, "Abre a tela para novo cadastro", Toast.LENGTH_SHORT).show();
